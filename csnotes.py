# Portal used to extract keywords from CIE textbook references from C1 to C20
import datetime
import io
import os
import fitz  # PyMuPDF
...
with tabs[5]:
    ...
    if pwd_input and pwd_input == admin_pwd:
        ...
        with col_b:
            ...
            st.markdown("<br>", unsafe_allow_html=True)
            st.link_button("📕 Open Paper 4 Drive (Ch 10,11,19,20)", drive_links.get("paper4", "https://drive.google.com"), type="primary", use_container_width=True)
    elif pwd_input:
